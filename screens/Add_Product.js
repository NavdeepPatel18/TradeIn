          ...
          <View style={styles.container}>
            <View style={styles.inputContainer}>
              <Picker
                ...
                onValueChange={(itemValue, itemIndex) =>
                  this.setState({category_name: itemValue})
                }>
                <Picker.Item
                ...
                <Picker.Item
                  label="Western Snacks"
                  value="Western Snacks"></Picker.Item>
              </Picker>
            </View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                underlineColorAndroid="transparent"
                onChangeText={(product_weight) =>
                  this.setState({product_weight})
                }
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                keyboardType="numeric"
                underlineColorAndroid="transparent"
                onChangeText={(product_price_distributor) =>
                  this.setState({product_price_distributor})
                }
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                keyboardType="numeric"
                underlineColorAndroid="transparent"
                onChangeText={(product_price_shopkeeper) =>
                  this.setState({product_price_shopkeeper})
                }
              />
            </View>
            ...
            <TouchableHighlight
              ...
              onPress={this.InsertuserRecordsToServer}>
